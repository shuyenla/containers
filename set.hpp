...
namespace ft {
    ...
    class set
    {
        ...
        public:
	    	...
	    	typedef ft::set_iterator<pair_type, key_type, nodePtr, Compare>					    iterator;
	   		typedef ft::set_iterator<const pair_type, const key_type, nodePtr, Compare>		    const_iterator;
